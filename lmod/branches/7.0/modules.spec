...
sed -i 's/bash)\ \.\ \/cm\/local\/apps\/environment-modules\/3\.2\.10\/\/Modules\/default\/init\/bash/bash)\ \.\ \/cm\/local\/apps\/environment-modules\/3\.2\.10\/\/Modules\/default\/init\/bash;\ export\ -f\ module/g' %{buildroot}/etc/profile.d/modules.sh
sed -i 's/sh)\ \.\ \/cm\/local\/apps\/environment-modules\/3\.2\.10\/\/Modules\/default\/init\/sh/sh)\ \.\ \/cm\/local\/apps\/environment-modules\/3\.2\.10\/\/Modules\/default\/init\/sh;\ export\ -f\ module/g' %{buildroot}/etc/profile.d/modules.sh
